    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Contact` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT, `telephone` TEXT, `email` TEXT)');
...
class _$ContactDao extends ContactDao {
  ...
  Future<int> updateContact(Contact contact) {
    return _contactUpdateAdapter.updateAndReturnChangedRows(
